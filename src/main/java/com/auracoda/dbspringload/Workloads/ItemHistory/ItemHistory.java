...
public class ItemHistory extends WorkloadService {
    ...
    public ItemHistory() {
        ...
        AddTableDefinition(
                "CREATE TABLE buckets_2 (" +
                        "id UUID DEFAULT gen_random_uuid() primary key" +
                        ")",
                "drop table buckets_2");

        AddTableDefinition(
                "CREATE TABLE item_history_2 (" +
                        ...
                        "CONSTRAINT fk_buckets_item_history FOREIGN KEY (bucket_id) REFERENCES buckets_2(id))",
                "drop table item_history_2");
    ...
    void PopulateBuckets(
        ...
        final String InsertSQLSingle = "insert into buckets_2 values " + InsertParameters;
    ...
    void PopulateHistory(
        ...
        final String InsertSQLSingle = "insert into item_history_2 values " + InsertParameters;
